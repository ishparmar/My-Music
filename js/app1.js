...
dir = "music/";
playlist = ["main dhoondne", "photograph"];
title = ["Main Dhoondne Ko", "Photograph"];
poster = ["images/main dhoondne.jfif", "images/photograph.jpg"];
artists = ["Arijit Singh", "Ed Sheeran"];
playlist_index = 0;
...
function fetchMusicDetail() {
    ...
    $("#b").attr("src", poster[playlist_index]);
